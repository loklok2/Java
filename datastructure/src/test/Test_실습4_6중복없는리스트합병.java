...
public class Test_실습4_6중복없는리스트합병 {
    ...
    static List<String> mergeList(List<String> list1, List<String> list2) {
        ArrayList<String> list3 = new ArrayList<>(); // 새로운 리스트 생성
	...
	public static void main(String[] args) {
		try {
			 ...
			 */
			Path input1 = Paths.get("C:/Users/loklok2/Desktop/K7_java/datastructure/a.txt");
			...
			Path input2 = Paths.get("C:/Users/loklok2/Desktop/K7_java/datastructure/a2.txt");
			...
			FileOutputStream file = new FileOutputStream("C:/Users/loklok2/Desktop/K7_java/datastructure/c.txt");
